...
<script>
  ...
  function logoutCheck() {
	  alert("로그아웃 처리 되었습니다.");
	  location.href = "<%=request.getContextPath()%>/Logout?logoutSw=main";
  }
</script>
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  <div class="container-fluid">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link active" href="http://192.168.50.157:9090/springGreen/Main">HOME</a>
      </li>
      <li class="nav-item">
      ...
      <% if(!login.equals("OK")) { %>
      <li class="nav-item">
        <a class="nav-link" href="<%=request.getContextPath()%>/login/Login?loginSw=main_Login">Login</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<%=request.getContextPath()%>/login/Join">Join</a>
      </li>
      <% } %>
    </ul>
  </div>
