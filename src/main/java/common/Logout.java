...
//		if(logoutSw.equals("storage_t5"))	viewPage = "/study/0224_storage/t5_Login.jsp";
		...
		else if(logoutSw.equals("exam03"))	viewPage = request.getContextPath()+"/Login?loginSw=Exam03_Login";
		else if(logoutSw.equals("main"))	viewPage = request.getContextPath()+"/Login?loginSw=main_Login";
